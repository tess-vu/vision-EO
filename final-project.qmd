...
| Notebook | Open in |
|----------|---------|
| **01 — Data Preprocessing** — STAC data access, dNBR computation, DEM aspect, building footprint rasterization, target mask generation | [↓ Download from GitHub](https://github.com/tess-vu/vision-EO/raw/main/final/01_data_preprocessing.ipynb) |
